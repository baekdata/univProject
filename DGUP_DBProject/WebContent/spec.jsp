    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-3 blog-sidebar">
			  ...
			  <a href="#" class="list-group-item active">스팩 현황</a>
        ...
        <div class="col-sm-8 blog-main">
          <div class="blog-post">
            <h2 class="blog-post-title">등록되어진 자격증 현황</h2>
            <table class="table table-bordered">
			  ...
			  <tbody>
<%
	List<SpecVo> list = ctrl.personSpec_status(session_id);
	for(int i=0; i<list.size(); i++) {
%>			  
			    <tr>
			      <th scope="row"><%=i+1%></th>
			      <td><%=list.get(i).getSpec_name()%></td>
